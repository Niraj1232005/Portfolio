  ...
  return (
    <SectionContainer className="pb-12 pt-16 sm:pb-16 sm:pt-24 md:pt-32">
      ...
      <motion.div
        ...
        className="relative mt-8 overflow-hidden rounded-2xl border border-white/10 bg-[#0f1117] p-5 backdrop-blur-md sm:mt-10 sm:rounded-3xl sm:p-10"
      >
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_16%_14%,rgba(99,102,241,0.12),transparent_38%),radial-gradient(circle_at_86%_18%,rgba(139,92,246,0.1),transparent_36%)]" />
        <div className="relative z-10 space-y-4 text-sm leading-7 text-slate-300 sm:space-y-5 sm:text-base sm:leading-8">
          <p>
