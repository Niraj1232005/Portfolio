      ...
      {!isExiting ? (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute h-56 w-56 rounded-full bg-gradient-to-r from-[#ff7a1a]/24 to-[#ff4f4f]/20 blur-2xl sm:h-72 sm:w-72 sm:blur-3xl"
          />
          ...
          <div className="pointer-events-none absolute inset-0">
            {particles.map((particle, index) => (
              <motion.span
                ...
                className="absolute rounded-full bg-[#665e51]/45"
                style={{
                  top: `${particle.top}%`,
                  left: `${particle.left}%`,
                  width: particle.size,
          ...
          >
            <motion.div
              animate={{
                scale: [1, 1.035, 1],
                boxShadow: [
                  "0 0 0 rgba(255,122,26,0.2)",
                  "0 0 34px rgba(255,122,26,0.32)",
                  "0 0 0 rgba(255,122,26,0.2)",
                ],
              }}
